package com.dyc.fileWriteRead.read;
...
//    public static byte[] readFileToByteArray( String str,String filePath ) throws Exception {
...
//            fw.write(str);
//        }finally{
//            if( byteArrayOutputStream != null ) inputStream.close();
