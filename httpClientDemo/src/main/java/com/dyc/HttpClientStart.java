...
public class HttpClientStart {
    ...
    public static HttpEntity getStringEntity() throws Exception{
        ...
        registerDTO.setAction("register");//注册接口
    ...
    private static String createUserDTO(){
        UserDTO userDTO = new UserDTO();
        userDTO.setNickName("tony");
        userDTO.setPassword("123456");
        userDTO.setUserName(AGENT+MERCHANT_CODE+userDTO.getNickName());
        String userStr = JSON.toJSONString(userDTO);
        System.out.println(userStr);
        String encryStr = encryptDES3(userStr,SALT_TXT);
        return encryStr;
    }
